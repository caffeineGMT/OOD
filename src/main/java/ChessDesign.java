...
public class ChessDesign {
    ...
    public class Board {
        ...
        public Spot getBox(int x, int y) throws InvalidMoveException {
            if (x < 0 || x > 7 || y < 0 || y > 7) {
    ...
    public class Game {
        ...
        public boolean playerMove(Player player, int startX, int startY, int endX, int endY) throws InvalidMoveException {
        ...
        private boolean makeMove(Move move, Player player) {
            ...
            // castling?
            if (sourcePiece != null && sourcePiece instanceof King && ((King) sourcePiece).isCastlingMove(move.start, move.end)) {
